...
class GenerateCode(Action):
    ...
    async def run(self, project, lex_app_context: str, code: str, class_to_generate: str):
        prompt = generate_project_code_prompt(project, lex_app_context, code, class_to_generate)
