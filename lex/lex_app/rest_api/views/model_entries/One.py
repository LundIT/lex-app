...
class OneModelEntry(ModelEntryProviderMixin, DestroyOneWithPayloadMixin, RetrieveUpdateDestroyAPIView, CreateAPIView):
    ...
    create(request, *args, **kwargs)
        Creates a new model entry and logs the operation.
    update(request, *args, **kwargs)
        Updates an existing model entry and logs the operation.
    """
    ...
    def create(self, request, *args, **kwargs):
        ...
        ----------
        request : Request
            The request object containing the data for the new model entry.
        *args : tuple
        ...
        **kwargs : dict
        ...
        -------
        Response
            The response object containing the created model entry data.
    ...
    def update(self, request, *args, **kwargs):
        ...
        ----------
        request : Request
            The request object containing the data for the model entry update.
        *args : tuple
            Additional positional arguments.
        **kwargs : dict
            Additional keyword arguments.
        ...
        -------
        Response
            The response object containing the updated model entry data.
